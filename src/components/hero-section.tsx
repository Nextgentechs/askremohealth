  ...
  return (
    <section className="mt-12 flex h-40 w-full gap-8 px-4 sm:h-56 sm:flex-row sm:justify-between sm:gap-12 lg:gap-16 lg:px-12 xl:mt-0 xl:h-[432px]">
      <div className="flex flex-grow flex-col items-center justify-center text-center lg:items-start lg:text-left">
        <h1 className="text-2xl font-extrabold leading-tight text-primary transition-all duration-300 sm:text-3xl lg:text-3xl xl:text-4xl 2xl:text-5xl">
      ...
      <Image
        src={Doctor}
        alt="Doctor Image"
        className="hidden lg:block lg:h-[434px] w-[454px] xl:h-[528px] xl:w-[520px] 2xl:h-[528px]"
        priority
      />
    </section>
  )
