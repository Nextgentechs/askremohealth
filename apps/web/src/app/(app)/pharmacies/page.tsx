...
export default function PharmaciesPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/20">
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-[#059669] to-[#10B981] py-16 text-white">
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center text-center">
            <Pill className="mb-4 h-16 w-16" />
            <h1 className="mb-4 text-4xl font-bold">Find Pharmacies</h1>
            <p className="mb-8 max-w-2xl text-lg text-white/80">
              Discover licensed pharmacies across Kenya. Get your prescriptions
              filled quickly and safely at trusted locations near you.
            </p>
          ...
          <div>
            <h2 className="text-2xl font-semibold">
              {isLoading ? (
                ...
                <>
                  {data?.pagination.total ?? 0} Pharmac
                ...
                <CardHeader className="pb-4">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <CardTitle className="line-clamp-2 text-lg group-hover:text-emerald-600">
                        {facility.name}
                      </CardTitle>
                    ...
                    <Pill className="h-10 w-10 text-emerald-500/20" />
                  </div>
                </CardHeader>
                <CardContent className="space-y-3">
                  ...
                  {facility.website && (
                    <div className="flex items-center gap-2 text-sm text-muted-foreground">
                      ...
                      <a
                        ...
                        className="line-clamp-1 hover:text-emerald-600 hover:underline"
                      >
                  ...
                  <div className="flex gap-2 pt-2">
                    <Button
                      ...
                      size="sm"
                    >
                      <Link href={`/pharmacies/${facility.placeId}`}>
                        View Details
                      </Link>
                    </Button>
