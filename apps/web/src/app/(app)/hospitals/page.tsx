...
export default function HospitalsPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/20">
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-[#402E7D] to-[#4A26C2] py-16 text-white">
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="mb-8 max-w-2xl text-lg text-white/80">
              Discover trusted healthcare facilities across Kenya. Search by
              location, specialty, or name to find the right hospital for your
              needs.
            </p>
          ...
          <div>
            <h2 className="text-2xl font-semibold">
              {isLoading ? (
                ...
                <>
                  {data?.pagination.total ?? 0} Hospital
        ...
        {isLoading ? (
          ...
          <Card className="py-16 text-center">
            <CardContent>
              ...
              <h3 className="mb-2 text-xl font-semibold">No Hospitals Found</h3>
              <p className="text-muted-foreground">
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="flex items-center gap-2 text-sm">
                    ...
                    <span className="font-medium text-primary">
                      {facility.doctors?.length ?? 0} Doctor
                      {(facility.doctors?.length ?? 0) !== 1 ? 's' : ''}
                    </span>
                  </div>

                  <div className="flex gap-2 pt-2">
                    <Button asChild className="flex-1" size="sm">
                      <Link href={`/hospitals/${facility.placeId}`}>
                        View Details
                      </Link>
                    </Button>
                    <Button asChild variant="outline" size="sm">
                      <Link
                        href={`/find-specialists?facility=${facility.placeId}`}
                      >
                        Find Doctors
                      </Link>
                    </Button>
