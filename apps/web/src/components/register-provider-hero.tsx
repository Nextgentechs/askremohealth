...
export default function RegisterProviderHero() {
  return (
        ...
        <div className="flex flex-col items-center space-y-4 text-center">
          <div className="space-y-2">
            ...
            <p className="mx-auto max-w-[900px] text-gray-500 md:text-md/relaxed lg:text-base/relaxed xl:text-md/relaxed">
              ...
              sustained success in the dynamic healthcare landscape. Let us partner in your journey to acquire, retain,
              and engage more patients, shaping a lasting impact in the realm of healthcare services. Your success is at
